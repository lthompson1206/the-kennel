...
* Start by scaffolding out a new starter React app by running the following command in your terminal `create-react-app the kennel`.

* cd into the `the kennel` directory and run the following command to install React Router and Axios:
...
* Open [https://pupster.netlify.com/](https://pupster.netlify.com/) in your web browser and take a few moments to study the example application. You will be basing your the kennel off of this example.
...
* Your the kennel should implement each of these three pages and their basic functionality, **don't spend much time styling your app until you have completed everything else.**

* Your the kennel should display a navigation bar that is present on every route.
